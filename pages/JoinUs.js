...
const Join = () => {
  return (
   <>
   <div class="container px-5 py-2 mx-auto bg-gradient-to-r from- to-blue-400" id='JoinUs'>
  ...
  <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6 ">
    ...
    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-3 md:mt-0">
      <h2 class="text-gray-900 text-lg mb-1 font-medium title-font py-1">Join Us Form</h2>
